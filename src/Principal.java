...
public class Principal {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("Seleccione segun la Monedas que desea Convertir: ");
            opcion = scanner.nextInt();

            switch (opcion) {
                case 1:
                    convertirMoneda("USD", "EUR", scanner);
                    System.out.println("Quiere continuar Convirtiendo? ");
                ...
                case 11:
                    ...
                    break;
                default:
                    System.out.println("Opción NO VALIDA, seleccione solo opciónes del menú.");
            }
        } while (opcion != 11);
        System.out.println("************************************************************************");
        System.out.println(" ");
        System.out.println("AGRADECEMOS SU PREFERENCIA POR USAR ESTA APP!");
        System.out.println(" ");
        System.out.println("************************************************************************");
    ...
    private static void convertirMoneda(String baseCode, String targetCode, Scanner scanner) {
        ...
        try {
            ...
            System.out.println("********************************************************************");
            System.out.println("SU MONEDA HA SIDO CONVERTIDA A LA OPCION DESEADA!");
            System.out.println("*********************************************************************");
